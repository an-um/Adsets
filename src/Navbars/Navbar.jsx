...
export const Navbar = (e) => {
    return (
        <section className='w-full px-2'>
            <div className='flex w-full gap-y-2 flex-wrap  bg-[#F2F2F2] py-3 px-4 lg:justify-between '>
                ...
                <CiMenuBurger className="icon"/>
                    ...
                    <h4 className='text-[#3F3F3F] text:text-xl 2xl:text-[2xl] font-bold'>Ad sets</h4>
                    <div className='min-[800px]:ps-6'>
                ...
                <div className='flex items-center flex-wrap gap-3'>
                    <p className='text-[#3F3F3F] font-semibold 2xl:text-[18px]'>Updated just now</p>
                    <div className='bg-[#E6E6E6] rounded-lg flex items-center justify-center py-3 px-4'>
                        <img src={refreshIcon} className='h-[11px] width: [14px] cursor-pointer' alt='refesh' />
                    </div>
                    <button className='bg-[#E6E6E6] text-[#3F3F3F] py-2 px-6 rounded-lg font-semibold 2xl:text-[18px]'>Discard drafts</button>
                    <button className='bg-[#1977F1] text-[#3F3F3F] py-2 px-6 rounded-lg text-white font-semibold 2xl:text-[18px]'>Review and publish (2)</button>
                    <div className='bg-[#E6E6E6] rounded-lg flex items-center justify-center py-3 px-4'>
                        <img src={dots} className='h-[16px] width:[16px] cursor-pointer' alt='refesh' />
                    </div>
                    <div className='bg-[#E6E6E6] rounded-lg flex items-center justify-center py-3 px-4'>
                        <img src={cross} className='h-[18px] width:[18px] cursor-pointer' alt='refesh' />
                    </div>
                </div>
            </div>
            <div className='bg-white  shadow-lg px-4 py-6 rounded-lg border-l-4 border-[#1977F1]'>
            ...
            <div className='shadow-lg w-full px-2 py-3'>
